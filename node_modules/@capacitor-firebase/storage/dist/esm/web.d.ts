...
import type { DeleteFileOptions, DownloadFileCallback, DownloadFileOptions, FirebaseStoragePlugin, GetDownloadUrlOptions, GetDownloadUrlResult, GetMetadataOptions, GetMetadataResult, ListFilesOptions, ListFilesResult, UpdateMetadataOptions, UploadFileCallback, UploadFileOptions, UseEmulatorOptions } from './definitions';
export declare class FirebaseStorageWeb extends WebPlugin implements FirebaseStoragePlugin {
    ...
    downloadFile(options: DownloadFileOptions, callback: DownloadFileCallback): Promise<string>;
